    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Box sx={{ background: "#E5EEEF" }}>
          ...
          {/* Provide Service To Patient */}
          <List>
            <ListItem disablePadding>
              <ListItemButton onClick={() => route("/provideservice")}>
                <ListItemIcon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"

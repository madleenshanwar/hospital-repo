  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem value="intravenous anesthesia">intravenous anesthesia</MenuItem>
        <MenuItem value="continuous anesthesia">continuous anesthesia</MenuItem>
      ...
      <TextField
        ...
        sx={{width:'300px'}}
      >
        {room.length>0?room.map(el=><MenuItem value={el}>{el}</MenuItem>)
        :''}
      </TextField>
